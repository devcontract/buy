    ...
    <div class="container">
      ...
      <div class="row">
        <div class="block" style="height:auto">
          <h2 class="text-center">Token Withdrawal</h2>
          ...
          <div class="" style="margin:40px 0;width:620px;display:flex;justify-content:space-between;">
            ...
            <div id="wrapper">
              <a href="" class="btn btn-lg myBtn" id="with-myetherwallet" type="button" name="" style="width:125px;height:34px;font-size:10px;margin-right:10px">MYETHERWALLET </a>
              <a href="" class="btn btn-lg myBtn" id="with-metamask" type="button" name="" style="width:125px;height:34px;font-size:10px;">METAMASK </a>
            </div>
...
<h2 class="text-center"> Token Withdrawal History</h2>
